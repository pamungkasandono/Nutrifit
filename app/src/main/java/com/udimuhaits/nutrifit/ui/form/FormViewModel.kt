...
class FormViewModel : ViewModel() {
    ...
    fun getUser(token: String?, id: Int?): LiveData<UserProfile> {
        ...
        UserApiConfig.getUserApiService(token).getUser(id).enqueue(object : Callback<UserProfile> {
    ...
    fun putUser(
        ...
        _isLoading.value = true
        UserApiConfig.getUserApiService(token).putUser(id, birthDate, height, weight)
