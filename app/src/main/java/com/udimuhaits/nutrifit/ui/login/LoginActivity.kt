...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (fUser != null) {
            val intent =
                Intent(this, FormActivity::class.java).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            if (sat.isSuccessful) {
                ...
                Log.d("asdasd", sat.exception.toString())
//                Toast.makeText(this, "${sat.exception}", Toast.LENGTH_SHORT).show()
            }
        }
    }
}